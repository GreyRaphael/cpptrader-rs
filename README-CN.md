...
| 场景 | 耗时 | 吞吐量 |
|---|---|---|
| 批量限价挂单（100 笔，无成交） | 12 µs | **830 万单/秒** |
| 批量限价挂单（1,000 笔，无成交） | 73 µs | **1,370 万单/秒** |
| 批量限价挂单（10,000 笔，无成交） | 620 µs | **1,610 万单/秒** |
| 市价扫单（1 个价格档，1,000 笔对手单） | 48 µs | **2,080 万笔/秒** |
| 市价扫单（10 个价格档，每档 100 笔对手单） | 49 µs | **2,040 万笔/秒** |
| FOK 跨 10 个价格档全部成交 | 47 µs | **2,130 万笔/秒** |
| FOK 扫描 10 个价格档后因量不足撤销 | 2.7 µs | — |
| 批量减少非队头订单（100 笔，同价格档） | 4.9 µs | **2,040 万次/秒** |
| 批量激活止损单（1,000 笔） | 79 µs | **1,270 万次/秒** |
